...
export function Signup() {
  ...
  const validateForm = () => {
    ...
    if (!formData.fullName.trim() || !fullNameRegex.test(formData.fullName)) {
      newErrors.fullName =
        "Full name is required and must be 3-50 characters long";
    }
    ...
    if (!formData.password || !passwordRegex.test(formData.password)) {
      newErrors.password =
        "Password is required and must be at least 8 characters long, including uppercase, lowercase, digit, and special character";
    }
  ...
  const handleGoogleSignup = () => {
    window.location.href =
      "https://ai-startup-idea-generator-mauve.vercel.app/api/auth/google";
  };
          ...
          <div className="bg-white w-[500px] rounded-xl shadow-lg border border-neutral-200 p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                <label
                  htmlFor="fullName"
                  className="block text-xs text-neutral-700 mb-1"
                >
                  Full Name
                </label>
