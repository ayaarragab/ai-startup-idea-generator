...
import { Mail, CheckCircle2, XCircle, RefreshCw, ArrowLeft } from 'lucide-react';
          ...
          {status === 'pending' && (
            <>
              ...
              <div className="text-center mb-6">
                ...
                <h1 className="text-neutral-900 mb-2">Verify Your Email</h1>
              ...
              <div className="mb-6">
                ...
                {verificationError && (
                  <p className="text-xs text-primary-600 text-center">{verificationError}</p>
                )}
